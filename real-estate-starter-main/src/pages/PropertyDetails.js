            ...
            <form className='flex flex-col gap-y-4'>
              ...
              />
               <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm'
                     ...
                     placeholder='Phone'
              />
              <textarea className='border border-gray-300 focus:border-violet-700 outline-none resie-none rounded w-full p-4 h-36 text-sm text-gray-400'
              placeholder='Message'
              ...
              <div className='flex gap-x-2'>
                <button className='bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition'>
                  Send message</button>
                <button className="border border-violet-700 text-violet-700 hover:border-violet-500 rounded p-4 text-sm w-full transition">
                  Call</button>
              </div>
            </form>
          </div>
